<%-- 
    ...
    Created on : Dec 7, 2023, 5:58:37 PM
    Author     : lenovo
--%>
...
<html>
    ...
    <body>
        <%
            ...
            int n = 10000 + ran.nextInt(90000);
        %>
        <div class="container">
            <header>Registration Here</header>
            <form action="newCustomerServlet" method="post" onsubmit="return myFun()">
                    ...
                    <div class="detail personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="contactnumber" id="contactnumber" placeholder="enter contact number" value="">
                                <span id="cerror"></span>
                            </div>
                            <br><br>
                            <div class="input-field">
                            ...
                            <div class="input-field">
                                <label>State:</label>
                                <input type="text" name="state" id="state" placeholder="enter state" value="">
                            ...
                            <div class="input-field">
                                ...
                                <input type="password" name="confirmpassword" id="confirmpassword" placeholder="enter password again" value="">
                    ...
                    <div class="detail personal">
                        ...
                        <div class="fields">
                            <div class="input-field">
                                ...
                                <input type="text" name="meterno" id="meterno"  value=<%=n%> readonly>
                            </div>
                            <div class="input-field">
                                <label>Pincode:</label>
                                <input type="text" name="pincode" id="pincode" placeholder="enter pin code" value="">
